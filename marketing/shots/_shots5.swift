...
let steps: [(String, String, Double)] = [
  ("15-diagnostico", "document.querySelector(\"[data-view='trainer']\").click(); setTimeout(function(){var g=[...document.querySelectorAll('button')].find(x=>/Generar an/i.test(x.textContent||'')); if(g)g.click();},600);", 3.2),
]
